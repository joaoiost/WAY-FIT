    ...
    <div className="bg-white" style={{ minHeight: '100vh' }}>
      ...
      <div className="report">
        ...
        <div className="no-print" style={{ display: 'flex', gap: 10, justifyContent: 'flex-end' }}>
          <button onClick={() => navigate(-1)} className="bg-ink-100"
            style={{ padding: '8px 16px', border: 'none', borderRadius: 8, cursor: 'pointer', fontSize: 13, fontWeight: 600, color: '#374151' }}>
            ← Voltar
          </button>
